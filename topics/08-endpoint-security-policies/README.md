# 08. Endpoint Security Policies

_Part: Manage Endpoints_
...
3. Configure the protection modules (see the Protection Modules topic).
...
[← Previous: Endpoint Groups & Tags](../07-endpoint-groups-tags/) · [Index](../../) · [Next: Protection Modules →](../09-protection-modules/)
